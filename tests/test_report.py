...
class ReportTests(unittest.TestCase):
    ...
    def test_counts(self):
        ...
        # meos_initialize (plumbing) + temporal_tagg (stateful) are by-design
        # exclusions, dropped from the coverage base; the other two gaps count.
        self.assertEqual(self.r["byDesignExcluded"], 2)
        self.assertEqual(self.r["actionableGap"], 2)
        # coverage is over the actionable base (public - by-design): 2 / 4
        self.assertEqual(self.r["coveragePct"], round(2 * 100 / 4, 1))
